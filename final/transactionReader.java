...
public class transactionReader {
    ...
    public static void paysAndTransfers(PersonDatabase people, String [] bankAccountData, int [] columnInfo){
        ...
        Customer fromCustomer = backEnd.findAccount(bankAccountData[columnInfo[0]] +" "+ bankAccountData[columnInfo[1]], people);

        Customer toCustomer = backEnd.findAccount(bankAccountData[columnInfo[4]] + " " + bankAccountData[columnInfo[5]], people);
    ...
    public static void deposit(PersonDatabase people, String [] bankAccountData, int [] columnInfo){
        Customer fromCustomer = backEnd.findAccount(bankAccountData[columnInfo[4]] +" "+ bankAccountData[columnInfo[5]], people);
        switch(bankAccountData[columnInfo[2]]){
            case "Savings":
