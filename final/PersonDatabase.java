...
public class PersonDatabase {
    ...
    public PersonDatabase(int counter) {
        ...
        this.table = new Customer[this.size][1];
    }
     ...
     */
    public void add_Person(Customer customerIn){
        ...
        int key = (int)customerIn.getIDNum()-1;
        //the line below uses the key to assign the checking account to the appropriate bucket
        if(customerIn.getIDNum() > this.highestID)
            this.highestID = customerIn.getIDNum();
        this.table[key][0] = customerIn;
