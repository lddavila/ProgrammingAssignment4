...
public class BankStatement {
    ...
    BankStatement(Customer customerIn, Account accountIn, double startingBalanceIn){
        this.customerInfo = customerIn;
        this.customerAccount = accountIn;
        this.startingBalance = startingBalanceIn;
        this.endingBalance = startingBalanceIn;
    }
